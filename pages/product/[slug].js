        ...
        <div className="container px-5 py-16 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                  ...
                  {Object.keys(variants).includes("purple") &&
                    Object.keys(variants["purple"]).includes(size) && (
                      <button
                        ...
                        className={`border-2 ml-1 bg-purple-400 rounded-full w-6 h-6 focus:outline-none ${
                          color === "purple"
                            ? "border-black"
                            : "border-gray-300"
                        }`}
                ...
                <div className="flex ml-6 items-center">
                  ...
                  <div className="relative">
                    <select
                      ...
                      className="rounded border appearance-none border-gray-300 py-2 focus:outline-none focus:ring-2 focus:ring-green-200 focus:border-green-400 text-base pl-3 pr-10"
                    >
              ...
              <div className="pin mt-6 flex space-x-6 text-sm">
                <input
                ...
                <button
                  ...
                  className="flex ml-14 text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded"
                >
                  Check
                </button>
              </div>
              ...
              {service && service != null && (
                <div className="text-green-700 mt-3">
                  Yay! This is pincode is serviceable.
                </div>
              )}
            </div>
          </div>
...
export async function getServerSideProps(context) {
  ...
  let colorSlugSize = {}; //{red: {xl: {slug: captain-america-xl}}}
  ...
  return {
    props: {
      ...
      variants: JSON.parse(JSON.stringify(colorSlugSize)),
    },
  };
}
