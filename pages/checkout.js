...
const Checkout = ({ cart, clearCart, addToCart, removeFromCart, subTotal }) => {
  return (
    <div className="container px-2 sm:m-auto">
        ...
        <div className="px-2 w-1/2">
          <div className="">
            ...
            <input
              ...
              id="name"
              name="name"
              className="w-full bg-white rounded border border-gray-300 focus:border-green-200 focus:ring-1 focus:ring-green-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
            />
          </div>
        </div>
        <div className="px-2 w-1/2">
      ...
      <div className="z-10  bg-green-200 p-6 m-2">
